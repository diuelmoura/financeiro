        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cartoes_Usuario_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GanhoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Descricao = table.Column<int>(maxLength: 50, nullable: false),
                    CategoriaId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ganhos_Usuario_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuario",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Depesas_Cartoes_DespesaId",
                        column: x => x.DespesaId,
                        principalTable: "Cartoes",
                        principalColumn: "CartaoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Depesas_Meses_MesId",
                        column: x => x.MesId,
                        principalTable: "Meses",
                        principalColumn: "MesId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Depesas_Usuario_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuario",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "b0586183-db24-4b5e-b7ac-e92b5c92e8b2", "f9734965-fb2b-4d42-9790-9341939e4976", "Administrador do Sistema", "Administrador", "ADMINISTRADOR" },
                    { "1bc26e0e-c26c-4610-bb8a-5a72d5aa47fc", "77f43376-1a6b-499b-999b-afddb89ce08b", "Usuario do Sistema", "Usuario", "USUARIO" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Depesas_MesId",
                table: "Depesas",
                column: "MesId");

            migrationBuilder.CreateIndex(
                name: "IX_Depesas_UsuarioId",
                table: "Depesas",
                column: "UsuarioId");
